	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link" href="<c:url value="/admin/person/list" />">人员管理</a>
                <a class="nav-item nav-link" href="<c:url value="/admin/activity/list" />">人才活动</a>
...
<script type="text/javascript">
	$(document).ready(function() {		
		$('.navbar-nav a[href^="/JcYJRC/admin/' + location.pathname.split("/")[2] + '"]').addClass('active');
	});
</script>
