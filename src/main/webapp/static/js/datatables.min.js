 ...
 *   https://datatables.net/download/#dt/dt-1.10.20/b-1.6.1/b-flash-1.6.1/fc-3.3.0/fh-3.1.6/r-2.2.3/sc-2.0.1
 *
 * Included libraries:
 *  DataTables 1.10.20, Buttons 1.6.1, Flash export 1.6.1, FixedColumns 3.3.0, FixedHeader 3.1.6, Responsive 2.2.3, Scroller 2.0.1
 */
...
sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"表中无数据",sInfo:"显示 _START_ 到 _END_ 共  _TOTAL_ 条记录",sInfoEmpty:"共 0 条记录",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"显示 _MENU_ 条记录",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"查询:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
...
classes:{},builder:"dt/dt-1.10.20/b-1.6.1/b-flash-1.6.1/fc-3.3.0/fh-3.1.6/r-2.2.3/sc-2.0.1",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},header:{}},order:{},type:{detect:[],search:{},order:{}},_unique:0,fnVersionCheck:q.fnVersionCheck,iApiIndex:0,oJUIClasses:{},sVersion:q.version};f.extend(C,{afnFiltering:C.search,aTypes:C.type.detect,ofnSearch:C.type.search,oSort:C.type.order,afnSortData:C.order,aoFeatures:C.feature,oApi:C.internal,oStdClasses:C.classes,oPagination:C.pager});
