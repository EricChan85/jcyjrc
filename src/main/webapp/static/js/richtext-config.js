...
rteImagePath = staticPath + "img/richtext/";//'<c:url value="/static/img/richtext/" />';//"../img/richtext/";
...
rteHTMLPathInsertLink = staticPath + "html/insert_link.html";
// Path to edit link popup.
rteHTMLPathEditLink = staticPath + "html/edit_link.html";
// Path to insert image popup.
rteHTMLPathInsertImage = staticPath + "html/insert_image.html";
